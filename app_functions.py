...
def print_question(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        template = "You rolled a {} and a {}... What is the sum of {} and {}?"
        print(template.format(die_1_value, die_2_value, die_1_value, die_2_value))
    elif question_type == "difference":
        template = "You rolled a {} and a {}... What is the difference between {} and {}?"
        print(template.format(die_1_value, die_2_value, die_1_value, die_2_value))
...
def is_correct_answer(die_1_value, die_2_value, question_type, given_answer):
    ...
    # complete this function below here
    if question_type == "sum":
        correct_value = die_1_value + die_2_value
    elif question_type == "difference":
        correct_value = abs(die_1_value - die_2_value)
    else:
        return False
    return given_answer == correct_value
...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        correct_value = die_1_value + die_2_value
        print("No! The sum of {} and {} is {}!".format(die_1_value, die_2_value, correct_value))
    elif question_type == "difference":
        correct_value = abs(die_1_value - die_2_value)
        print("No! The difference between {} and {} is {}!".format(die_1_value, die_2_value, correct_value))
